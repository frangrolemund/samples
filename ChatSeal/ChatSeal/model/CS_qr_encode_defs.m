...
/*********************************************
 QR Code version information (model number)
 *********************************************/
CS_QRE_VERSIONINFO CS_QRE_VersionInfo[] = {{0},
    { 1, // Ver.1
        26,   19,   16,   13,    9,
        0,   0,   0,   0,   0,   0,   0,
        1,  26,  19,
...
/*********************************************
 GF --> integer index conversion table (2 ^ 8) α
 *********************************************/
unsigned char CS_QRE_byExpToInt[] = {
...
/*********************************************
 GF --> integer index conversion table (2 ^ 8) α
 *********************************************/
unsigned char CS_QRE_byIntToExp[] = {
...
/*********************************************
 Generator polynomial error correction coefficient α
 *********************************************/
...
/*********************************************
 Length indicator bit characters (another version group, {S, M, L})
 *********************************************/
int CS_QRE_nIndicatorLenNumeral[]  = {10, 12, 14};
int CS_QRE_nIndicatorLenAlphabet[] = { 9, 11, 13};
int CS_QRE_nIndicatorLen8Bit[]     = { 8, 16, 16};
int CS_QRE_nIndicatorLenKanji[]	= { 8, 10, 12};
