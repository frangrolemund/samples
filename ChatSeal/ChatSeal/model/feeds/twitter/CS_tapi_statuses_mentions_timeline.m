//
//  CS_tapi_statuses_mentions_timeline.m
//  ChatSeal
//
...
#import "CS_tapi_statuses_mentions_timeline.h"
#import "ChatSeal.h"
...
// - constants
static const NSUInteger CS_TAPI_SM_MAX_COUNT = 100;             //  less than the publicized maximum for home timeline requests because that will return an immense amount of data.


/***********************************
 CS_tapi_statuses_mentions_timeline
 REF: https://dev.twitter.com/docs/api/1.1/get/statuses/mentions_timeline
 ***********************************/
@implementation CS_tapi_statuses_mentions_timeline
/*
...
-(id) initWithCreatorHandle:(CS_netFeedCreatorDelegateHandle *)cdh inCategory:(cs_cnt_throttle_category_t)category
{
    ...
    if (self) {
        [self setMaxCount:CS_TAPI_SM_MAX_COUNT];
    }
    return self;
}
...
-(NSURLRequest *) generateRequestWithError:(NSError **)err
{
    ...
    [mdParms removeObjectForKey:@"exclude_replies"];    
